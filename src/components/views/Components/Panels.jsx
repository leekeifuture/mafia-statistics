            ...
            <div>
                <GridContainer>
                        ...
                        <Card>
                            <CardHeader>
                                <h4 className={classes.cardTitle}>
                                    Navigation Pills <small> - Horizontal
                                    Tabs</small>
                                </h4>
                            </CardHeader>
                            <CardBody>
                    ...
                    <GridItem xs={12} sm={12} md={6}>
                        <Card>
                            <CardHeader>
                                <h4 className={classes.cardTitle}>
                                    Navigation Pills <small> - Vertical
                                    Tabs</small>
                                </h4>
                            </CardHeader>
                            <CardBody>
                ...
                <GridContainer>
                    <GridItem xs={12} sm={12} md={6}>
                        <Card>
                            <CardHeader>
                                <h4 className={classes.cardTitle}>Collapsible
                                    Accordion</h4>
                            </CardHeader>
                            <CardBody>
                                <Accordion
                    ...
                    <GridItem xs={12} sm={12} md={6}>
                        <Card>
                            <CardHeader>
                                <h4 className={classes.cardTitle}>
                                    Navigation Pills Icons <small> - Vertical
                                    Tabs</small>
                                </h4>
                            </CardHeader>
                            <CardBody>
                            ...
                            tabs={[
                                ...
                                },
                                {
                                    ...
                                    tabContent: (
                                        <Card>
                                            <CardHeader>
                                                <h4 className={classes.cardTitle}>Help
                                                    center</h4>
                                                <p className={classes.cardCategory}>
                                                    More information here
                                                </p>
                                            ...
                                            <CardBody>
                                                From the seamless transition of
                                                glass and metal to the
                                                streamlined profile, every
                                                detail was carefully
                                                considered to enhance your
                                                ...
                                                in your hand. The cover
                                                glass curves down around the
                                                sides to meet the anodized
                                                aluminum enclosure in a
