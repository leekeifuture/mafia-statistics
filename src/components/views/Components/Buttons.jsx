...
import buttonsStyle
    from 'assets/jss/material-dashboard-pro-react/views/buttonsStyle.jsx'
            ...
            <Card>
                <CardBody>
                    <GridContainer>
                        <GridItem xs={12} sm={12} md={6}>
                            <div className={classes.cardHeader}>
                                <h4 className={classes.cardTitle}>Pick your
                                    Color</h4>
                            </div>
                            <div className={classes.cardContentLeft}>
                                <Button
                                    className={classes.marginRight}>Default</Button>
                        ...
                        <GridItem xs={12} sm={12} md={6}>
                            <div className={classes.cardHeader}>
                                <h4 className={classes.cardTitle}>Buttons with
                                    Label</h4>
                            </div>
                    ...
                    <GridContainer>
                        ...
                        <GridItem xs={12} sm={12} md={6}>
                            <div className={classes.cardHeader}>
                                <h4 className={classes.cardTitle}>Button
                                    Group</h4>
                            </div>
                            <div className={classes.cardContentRight}>
                    ...
                    <GridContainer>
                        <GridItem xs={12}>
                            <div className={classes.cardHeader}>
                                <h4 className={classes.cardTitle}>Social
                                    buttons</h4>
                            </div>
