...
import pricingPageStyle
    from 'assets/jss/material-dashboard-pro-react/views/pricingPageStyle.jsx'
            ...
            <div className={classes.container}>
                <GridContainer justify="center">
                    <GridItem xs={12} sm={12} md={6}>
                        <h2 className={classes.title}>Pick the best plan for
                            you</h2>
                    ...
                    <GridItem xs={12} sm={12} md={3}>
                        <Card pricing plain>
                            <CardBody pricing plain>
                                ...
                                <p className={classes.cardCategory}>
                                    This is good if your company size is 99+
                                    persons.
                                </p>
                                <Button round color="white">
                                    Choose plan
