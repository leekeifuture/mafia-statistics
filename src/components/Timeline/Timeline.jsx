...
import timelineStyle
    from 'assets/jss/material-dashboard-pro-react/components/timelineStyle.jsx'
                        ...
                        <div className={panelClasses}>
                            {prop.title ? (
                                <div className={classes.timelineHeading}>
                                    <Badge
                                        color={prop.titleColor}>{prop.title}</Badge>
                                </div>
                            ) : null}
                            <div
                                className={classes.timelineBody}>{prop.body}</div>
                            {prop.footerTitle ? (
