...
import sweetAlertStyle
    from 'assets/jss/material-dashboard-pro-react/views/sweetAlertStyle.jsx'
                ...
                <GridContainer>
                        ...
                        <Card>
                            <CardBody>
                                <div className={classes.center}>
                                    ...
                                    <Button color="rose"
                                            onClick={this.htmlAlert.bind(this)}>
                                        Try me!
                                    </Button>
                                </div>
                            </CardBody>
                    ...
                    <GridItem xs={12} sm={12} md={3}>
                        <Card>
                            <CardBody>
                                <div className={classes.center}>
                                    <h5>A message with auto close timer set to 2
                                        seconds</h5>
                                    <Button color="rose"
